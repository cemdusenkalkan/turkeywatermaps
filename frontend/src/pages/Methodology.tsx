  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-12">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-navy-900">{t('methodology.title')}</h1>
        <p className="text-gray-600 text-base md:text-lg mb-8 md:mb-10 leading-relaxed">{t('methodology.subtitle')}</p>
        
        <div className="space-y-6 md:space-y-8">
          <div className="bg-white border border-gray-200 p-6 md:p-8 rounded-2xl">
            <h2 className="text-xl md:text-2xl font-semibold mb-4 text-gray-900">{t('methodology.dataSource')}</h2>
          ...
          <div className="bg-white border border-gray-200 p-6 md:p-8 rounded-2xl">
            <h2 className="text-xl md:text-2xl font-semibold mb-4 text-gray-900">GitHub Repository</h2>
            <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-3">
          ...
          <div className="bg-white border border-gray-200 p-6 md:p-8 rounded-2xl">
            <h2 className="text-xl md:text-2xl font-semibold mb-4 text-gray-900">Citation</h2>
            <pre className="bg-gray-50 p-4 md:p-6 rounded-xl border border-gray-300 text-xs md:text-sm overflow-x-auto text-gray-900 font-mono leading-relaxed">
