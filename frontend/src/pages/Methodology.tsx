      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 md:p-8 rounded-2xl">
            <h2 className="text-xl md:text-2xl font-semibold mb-4 text-gray-900 dark:text-white">{t('methodology.githubRepo')}</h2>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm md:text-base">
              {t('methodology.githubRepoDesc')}
            </p>
          </div>
          
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 md:p-8 rounded-2xl">
            <h2 className="text-xl md:text-2xl font-semibold mb-4 text-gray-900 dark:text-white">{t('methodology.citation')}</h2>
